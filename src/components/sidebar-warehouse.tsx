...
export function AppSidebarWareHouse({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const data = {
    ...
    navMain: [
      {
        title: "Home",
        url: `/${locale}/warehouse`,
        icon: HomeIcon,
      },
      {
        title: "My Stocks",
        url: `/${locale}/warehouse/My-Stocks`,
        icon: BoxIcon,
},
